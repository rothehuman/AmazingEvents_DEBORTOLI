...
//Dado un arreglo de events y una fecha, retorna un ARREGLO con los eventos anteriores a la fecha pasada
function pastEvents(events, datee){
    let cardsE = ''
...
let tarjetas = pastEvents(data.events, data.currentDate);
